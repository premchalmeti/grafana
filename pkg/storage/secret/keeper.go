...
type SecretKeeper interface {
	Encode(ctx context.Context, value SaltyValue) (string, error)
	Decode(ctx context.Context, value SaltyValue) (string, error)
}
...
func (s *simpleKeeper) Encode(ctx context.Context, value SaltyValue) (string, error) {
	return base64.StdEncoding.EncodeToString([]byte(value.Salt + value.Value)), nil
}

// Decode implements SecretKeeper.
func (s *simpleKeeper) Decode(ctx context.Context, value SaltyValue) (string, error) {
